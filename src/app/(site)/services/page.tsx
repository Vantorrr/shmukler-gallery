...
const SERVICES = [
  ...
  },
  {
    ...
    shortDesc: 'Профессиональная оценка произведений искусства',
    description: 'Проводим экспертизу подлинности и рыночную оценку произведений современного российского искусства. Выдаём официальное заключение для страхования, продажи или нотариального оформления.',
  },
  {
    id: 6,
